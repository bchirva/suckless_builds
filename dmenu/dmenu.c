...
/* enums */
enum { SchemeNorm, SchemeSel, SchemeIn, SchemeOut, SchemeLast }; /* color schemes */
...
main(int argc, char *argv[])
{
	...
	for (i = 1; i < argc; i++)
		...
		/* these options take one argument */
			...
			colortemp[3] = argv[++i];
		else if (!strcmp(argv[i], "-ib"))  /* input background color */
			colortemp[4] = argv[++i];
		else if (!strcmp(argv[i], "-if"))  /* input foreground color */
			colortemp[5] = argv[++i];
